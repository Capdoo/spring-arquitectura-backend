...
@Entity
@Table(name="carpmarcos")

public class CarpinteriaMarcoModel {
	...
	public CarpinteriaMarcoModel(long id, String nombreCarpinteria, String transmitanciaCarpinteria) {
		super();
		this.id = id;
